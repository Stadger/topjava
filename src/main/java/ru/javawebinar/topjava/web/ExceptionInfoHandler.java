...
public class ExceptionInfoHandler {
    ...
    private static ErrorInfo logAndGetErrorInfo(HttpServletRequest req, Exception e, boolean logException, ErrorType errorType, String... bindError) {
        ...
        String details = bindError[0] != null ? bindError[0] : rootCause.toString();
