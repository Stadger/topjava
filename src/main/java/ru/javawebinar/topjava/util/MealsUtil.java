...
public class MealsUtil {
    ...
    public static List<Meal> meals1() {
    ...
    public static List<Meal> meals2() {
        return Arrays.asList(
                new Meal(LocalDateTime.of(2021, Month.JANUARY, 30, 10, 0), "Завтрак User2", 500),
                new Meal(LocalDateTime.of(2019, Month.JANUARY, 30, 13, 0), "Обед User2", 1000),
                ...
                new Meal(LocalDateTime.of(2020, Month.JANUARY, 31, 10, 0), "Завтрак User2", 2000),
                new Meal(LocalDateTime.of(2020, Month.JANUARY, 17, 13, 0), "Обед  User2", 500),
                new Meal(LocalDateTime.of(2020, Month.JANUARY, 17, 20, 0), "Ужин  User2", 410)
        );
    }
